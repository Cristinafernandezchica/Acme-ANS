...
@Setter
@Table(indexes = {
	@Index(columnList = "flight_crew_member_assigned_id, leg_related_id"), @Index(columnList = "flight_crew_member_assigned_id"), @Index(columnList = "flightCrewsDuty, leg_related_id, draftMode")
})
