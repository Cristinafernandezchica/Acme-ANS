...
@ValidBooking
@Table(indexes = {
	@Index(columnList = "draftMode"), @Index(columnList = "locatorCode"), @Index(columnList = "customer_id, draftMode, travelClass"), @Index(columnList = "customer_id, draftMode, id"), @Index(columnList = "customer_id, draftMode"),
})
