...
<acme:form>
	...
	<jstl:if test="${acme:anyOf(_command, 'update')}">
		<acme:input-textbox code="authenticated.assistance-agent.form.label.employeeCode" path="employeeCode" readonly="true"/>
		<acme:input-moment code="authenticated.assistance-agent.form.label.moment" path="moment" readonly="true"/>
	</jstl:if>
	
	<acme:input-textarea code="authenticated.assistance-agent.form.label.spokenLanguages" path="spokenLanguages"/>
	<acme:input-textarea code="authenticated.assistance-agent.form.label.briefBio" path="briefBio"/>
	...
	<acme:input-url code="authenticated.assistance-agent.form.label.picture" path="picture"/>
