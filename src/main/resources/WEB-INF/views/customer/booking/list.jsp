...
<acme:list>
	<acme:list-column code="customer.booking.list.locatorCode" path="locatorCode" width="15%"/>
	<acme:list-column code="customer.booking.list.purchaseMoment" path="purchaseMoment" width="20%"/>
	<acme:list-column code="customer.booking.list.travelClass" path="travelClass" width="15%"/>
	<acme:list-column code="customer.booking.list.price" path="price" width="20%"/>
	<acme:list-column code="customer.booking.list.flight" path="flight" width="30%"/>
