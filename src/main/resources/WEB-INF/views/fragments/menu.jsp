...
<acme:menu-bar>
	<acme:menu-left>
		...
		<acme:menu-option code="master.menu.flight-crew-member" access="hasRealm('FlightCrewMember')">
			<acme:menu-suboption code="master.menu.flight-crew-member.flight-assignment.plannedList" action="/flight-crew-member/flight-assignment/plannedList"/>
			<acme:menu-suboption code="master.menu.flight-crew-member.flight-assignment.completedList" action="/flight-crew-member/flight-assignment/completedList"/>
		</acme:menu-option>
